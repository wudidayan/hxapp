...
- (void)viewDidLoad {
    ...
    self.bgViewBalance.backgroundColor = [UIColor whiteColor];
    self.bgViewBalance.layer.masksToBounds = YES;
    self.bgViewBalance.layer.cornerRadius = 5.0;
    
//    self.tatolLabel.text = [NSString stringWithFormat:@"%.2f",[TDBalanceInfo balanceDefault].acBal.floatValue/100];
    self.checkDone.text = [NSString stringWithFormat:@"¥%.2f",[TDBalanceInfo balanceDefault].acT1AP.floatValue/100];
    self.notCheck.text = [NSString stringWithFormat:@"¥%.2f",[TDBalanceInfo balanceDefault].acT1UNA.floatValue/100];
    self.checkFail.text = [NSString stringWithFormat:@"¥%.2f",[TDBalanceInfo balanceDefault].acT1AUNP.floatValue/100];
    
    self.fastPayBalance.text = [NSString stringWithFormat:@"¥%.2f",[TDBalanceInfo balanceDefault].acT1AP_ACT03.floatValue/100];
    self.scanCodeBalance.text = [NSString stringWithFormat:@"¥%.2f",[TDBalanceInfo balanceDefault].acT1AP_ACT04.floatValue/100];
    self.totalBalance.text = [NSString stringWithFormat:@"¥%.2f",[TDBalanceInfo balanceDefault].balanceDisp.floatValue/100];
